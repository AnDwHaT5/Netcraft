...
import com.vfluff5.netcraft.models.ModelRouter;
...
public class RenderRouter extends TileEntitySpecialRenderer {
	...
	ResourceLocation texture = new ResourceLocation(Netcraft.MODID + ":textures/blocks/router.png");

	//The model of your block
	private final ModelRouter model;

	public RenderRouter() {
		this.model = new ModelRouter();
	}
